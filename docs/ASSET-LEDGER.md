...
public/art/furniture/| single-sprite CROPS from ElizaWy LPC Objects (anvil/bed/table/dresser/fireplace) + [LPC] Statues (altar) + **[LPC] Grave Markers Rework (bluecarrot16) → grave_headstone/cross/woodcross/open/large** — same ledgered sources as asset-library/2d/items | OGA-BY-3.0 / CC-BY-3.0 / CC-BY-SA-3.0 / GPL-3.0 | yes | interior furniture + cemetery markers
```
