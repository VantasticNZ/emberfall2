...
export const PROPS = {
  ...
  prop_seawater:  { src: 'art/terrain/water.png', width: 32, height: 32, footprint: null },   // a single ocean tile (reuses the ledgered water tile) — lay as a sea strip in coast settlements
  ...
  prop_bed:       { src: 'art/furniture/bed.png',       width: 46, height: 69, footprint: null }, // a single bed (homes / tavern upstairs)
  ...
  prop_stool:     { src: 'art/furniture/stool.png',     width: 24, height: 32,  footprint: null }, // a bar stool (tavern)
  prop_bench:     { src: 'art/furniture/bench.png',     width: 56, height: 28,  footprint: null }, // a padded bench (chapel pews)
  prop_shelf:     { src: 'art/furniture/shelf.png',     width: 32, height: 96,  footprint: null }, // a stocked shelf (shop)
